...
if %NODE_VER% lss 20 (
    echo [!!] Node.js v%NODE_VER% found — v20+ required
    echo.
...
if %AGENT_FOUND% equ 0 (
    ...
    echo   opencode (free):    https://opencode.ai
    echo.
)
...
if %ERRORLEVEL% equ 0 (
    ...
    echo [--] ffmpeg not found ^(optional, recommended^)
)
...
echo.
echo   cd %INSTALL_DIR%
echo   node packages\akari-launcher\bin\akari.mjs
echo.
